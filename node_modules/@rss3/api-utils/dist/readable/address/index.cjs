...
var nameService_js = require('../../name-service.js');
...
function formatAddressAndNS(address) {
  ...
  if (nameService_js.isSupportedNS(address)) {
...
exports.addressToAvatarURL = addressToAvatarURL;
exports.formatAddress = formatAddress;
exports.formatAddressAndNS = formatAddressAndNS;
exports.isAddress = isAddress;
exports.isMastodon = isMastodon;
