import type { Character, IAgentRuntime, IElizaOS, UUID, Memory, State, Plugin, RuntimeSettings, Content, SendMessageOptions, SendMessageResult, IDatabaseAdapter } from './types';
/**
...
export declare class ElizaOS extends EventTarget implements IElizaOS {
     ...
     * });
     */
    sendMessage(target: UUID | IAgentRuntime, message: Partial<Memory> & {
        entityId: UUID;
        roomId: UUID;
        content: Content;
        worldId?: UUID;
