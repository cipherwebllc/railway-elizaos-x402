 ...
 */
export declare function handleTextToSpeech(runtime: IAgentRuntime, input: string | OpenAITextToSpeechParams): Promise<ReadableStream<Uint8Array> | NodeJS.ReadableStream>;
